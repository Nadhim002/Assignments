...
function solutionFunction(inventory ){
    ...
    const BMWAndAudi = inventory.filter( (obj) => obj.car_make &&  ["bmw","audi"].includes(obj.car_make.toLowerCase() ) )
...
let inventory = [
    ...
    { id: 49, car_make: null, car_year: null },
    { id: 50,  car_model: "Town Car" },
  ];
