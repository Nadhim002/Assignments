...
function solutionFunction(inventory  ){
    ...
    let carModelList = inventory.map( 
        (obj) =>  obj.car_model || "Model not available" )

    const outputSet =  new Set( carModelList.sort() )
...
let inventory = [
    ...
    { id: 26, car_make: "Cadillac", car_forEachmodel: "Escalade", car_year: 2005 },
    ...
    { id: 48, car_model: "", car_year: 2008 },
    { id: 49, car_make: "Chrysler", car_year: 1996 },
    { id: 50, car_make: "Lincoln", car_model: null },
  ];
