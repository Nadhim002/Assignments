...
function promiseGiver(resolveTime, messageToSHow) {
  return new Promise((resolve, reject) => {
    setTimeout(() => resolve(messageToSHow), resolveTime * 1000)
  })
}

function resolveAndCall(data) {
  console.log(data)
  promiseGiver(3, "Step 2 Complete").then((data) => console.log(data))
}

const promise = promiseGiver(3, "Step 1 complete")
